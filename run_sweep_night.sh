...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.max_n_frames=1500000 \
...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.off_policy_n_envs_per_worker=4 experiment.off_policy_train_batch_size=128 \
    experiment.off_policy_memory_size=7000 experiment.off_policy_n_optimizer_steps=20 \
    experiment.checkpoint_interval=120000 experiment.wandb_extra_kwargs.name="lux_v2_qmix_seq"
