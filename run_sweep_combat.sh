#!/bin/bash
# Sequential training script for Thesis (Combat - 16 Channels)
...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.checkpoint_interval=150000 experiment.keep_checkpoints_num=20 experiment.exclude_buffer_from_checkpoint=true experiment.project_name="Lux_Thesis_Combat_BiggerCNN" experiment.wandb_extra_kwargs.name="mappo_combat_biggercnn_3M_run"
...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.checkpoint_interval=150000 experiment.keep_checkpoints_num=20 experiment.exclude_buffer_from_checkpoint=true experiment.project_name="Lux_Thesis_Combat_BiggerCNN" experiment.wandb_extra_kwargs.name="qmix_combat_biggercnn_3M_run"
...
XLA_PYTHON_CLIENT_PREALLOCATE=false WANDB_START_METHOD=thread python benchmarl/run.py \
    ...
    experiment.checkpoint_interval=150000 experiment.keep_checkpoints_num=20 experiment.exclude_buffer_from_checkpoint=true experiment.project_name="Lux_Thesis_Combat_BiggerCNN" experiment.wandb_extra_kwargs.name="masac_combat_biggercnn_3M_run"
